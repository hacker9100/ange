...
class Util {
    ...
    function getTopLogo() {
    	$logopath = $_SERVER['DOCUMENT_ROOT']."/files/campus/image/".Util::get_session("S_USER_INST_ID")."_logo.jpg";
    	if (file_exists($logopath)) {
    		return "/files/campus/image/".Util::get_session("S_USER_INST_ID")."_logo.jpg";
    	}else{
