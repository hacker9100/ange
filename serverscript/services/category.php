        ...
        case "GET":
            if (isset($_id)) {
                $sql = "SELECT
                            ...
                            CASE C.PARENT_NO WHEN 0 THEN C.CATEGORY_NM ELSE (SELECT CATEGORY_NM FROM CATEGORY WHERE NO = C.PARENT_NO) END AS PARENT_NM,
...
//                }
        ...
        case "POST":
            ...
            $sql = "INSERT INTO CATEGORY
                    (
                        ...
                        ".( isset($form[PARENT]) ? $form[PARENT][NO] : 0 )."
                        , '".$form[CATEGORY_NM]."'
                        , '".$form[CATEGORY_GB]."'
                        , '0'
                        , SYSDATE()
        ...
        case "PUT":
            ...
            $sql = "UPDATE CATEGORY
                    SET
                        PARENT_NO = ".( isset($FORM[PARENT]) ? $FORM[PARENT][NO] : 0 )."
                        ,CATEGORY_NM = '".$FORM[CATEGORY_NM]."'
                        ,CATEGORY_GB = '".$FORM[CATEGORY_GB]."'
                        ,CATEGORY_ST = '".$FORM[CATEGORY_ST]."'
                        ,REG_DT = '".$FORM[REG_DT]."'
                        ,NOTE = '".$FORM[NOTE]."'
                    WHERE
                        NO = ".$_id."
        ...
        case "DELETE":
            ...
            $sql = "DELETE FROM CATEGORY WHERE NO = ".$_id;
