...
//                }
            ...
            $sql = "SELECT NO, TARGET_NO ,JOIN_NO, USER_ID, NICK_NM, REVIEW_FL, JOIN_GB
                 FROM ANGE_COMP_WINNER
            ...
            $sql = "SELECT
                        ...
                        FROM
                        (
                                SELECT  NO, SUBJECT, WINNER_DT,EVENT_GB
                                FROM ANGE_EVENT
           ...
           if(isset($_search[BOARD_NEXT]) && $_search[BOARD_NEXT] != "") {

                $sql = "SELECT NO, SUBJECT FROM ANGE_EVENT WHERE WINNER_DT < DATE_FORMAT(NOW(), '%Y-%m-%d') AND NO > ".$_search[KEY]." AND  EVENT_GB='".$_search[EVENT_GB]."' ORDER BY NO LIMIT 1";
                ...
                $sql = "SELECT NO, SUBJECT FROM ANGE_EVENT WHERE WINNER_DT < DATE_FORMAT(NOW(), '%Y-%m-%d') AND NO < ".$_search[KEY]." AND EVENT_GB='".$_search[EVENT_GB]."' ORDER BY  NO DESC LIMIT 1";
            ...
            if (isset($_page)) {
                ...
                $sql = "SELECT
                                NO, TARGET_NO, JOIN_NO, SUBJECT, USER_ID,  REVIEW_FL, NICK_NM,  TOTAL_COUNT
                            FROM
                            (
                                SELECT NO, TARGET_NO, JOIN_NO, (SELECT SUBJECT FROM ANGE_EVENT WHERE NO = TARGET_NO) AS SUBJECT, USER_ID,  REVIEW_FL, NICK_NM
                                FROM (
                                    SELECT NO, TARGET_NO ,JOIN_NO, USER_ID, NICK_NM, REVIEW_FL, JOIN_GB
                                    FROM ANGE_COMP_WINNER
                                    WHERE 1=1
                                    ".$search_where."
                            )A
