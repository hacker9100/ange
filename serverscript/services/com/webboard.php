...
//                MtUtil::_d("FUNC[processApi] 1 : "+$id);
                ...
                $sql = "SELECT
                            ...
                            (SELECT NOTE FROM CMS_CATEGORY WHERE NO = CATEGORY_NO) AS CATEGORY_NM,BLIND_FL,PHOTO_REPLY_COUNT
                        FROM (
                            SELECT
                                ...
                                (SELECT COUNT(*) AS REPLY_COUNT FROM COM_REPLY WHERE TARGET_NO = B.NO AND TARGET_GB = 'PHOTO') AS PHOTO_REPLY_COUNT
                            FROM
                              COM_BOARD B
