 ...
 * Date   : 2014-09-23
 * Description : ange_common.html 화면 콘트롤러
 */
...
define([
    ...
    // 사용할 서비스를 주입
    controllers.controller('ange_common', ['$timeout', '$scope', '$rootScope', '$location', '$q', 'dataService', 'dialogs', function ($timeout, $scope, $rootScope, $location, $q, dataService, dialogs) {
...
//                        alert('접근할 수 없는 메뉴 입니다.');
        ...
        $scope.getMenu = function() {
            ...
            $q.all([
                    $scope.getList('menu', {}, {CHANNEL_GB: 'ADMIN'}, false).then(function(data){$rootScope.ange_channel = data;}),
                    $scope.getList('menu', {}, {MENU_GB: 'ADMIN'}, false).then(function(data){$rootScope.ange_menu = data;})
                ])
                .then( function() {
                    deferred.resolve();
                },function(error) {
        ...
        if ($rootScope.ange_channel == undefined) {
//            $scope.getMenu();
        }
