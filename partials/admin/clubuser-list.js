 ...
 * Date   : 2014-09-23
 * Description : clubuser-list.html 화면 콘트롤러
 */
...
define([
    ...
    // 사용할 서비스를 주입
    controllers.controller('clubuser-list', ['$scope', '$stateParams', '$location', '$filter', '$q', '$modal', 'dialogs', 'ngTableParams', 'CONSTANT', function ($scope, $stateParams, $location, $filter, $q, $modal, dialogs, ngTableParams, CONSTANT) {
