 ...
 * Date   : 2014-09-23
 * Description : user-main.html 화면 콘트롤러
 */
...
define([
    ...
    // 사용할 서비스를 주입
    controllers.controller('user-main', ['$scope', '$stateParams', '$location', '$filter', 'dialogs', 'ngTableParams', function ($scope, $stateParams, $location, $filter, dialogs, ngTableParams) {
...
//                            $defer.resolve(orderedData.slice((params.page() - 1) * params.count(), params.page() * params.count()));
        ...
        $scope.click_checkUserId = function () {
            $scope.getItem('com/user', 'check', $scope.item.USER_ID, {}, false)
                .then(function(data) {
                    if (data.COUNT < 1) {
                        check = true;
