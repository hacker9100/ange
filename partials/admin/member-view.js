...
define([
    ...
    // 사용할 서비스를 주입
    controllers.controller('member-view2', ['$scope', '$stateParams', '$location', '$filter', 'dialogs', function ($scope, $stateParams, $location, $filter, dialogs) {
...
//            $location.url('/member/list');
        ...
        $scope.getUser = function () {
            if ($stateParams.id != 0) {
                $scope.getItem('com/user', 'item', $stateParams.id, {DETAIL: true}, false)
                    .then(function(data) {
