 ...
 * Date   : 2014-09-23
 * Description : member-write-list.html 화면 콘트롤러
 */
...
define([
    ...
    // 사용할 서비스를 주입
    controllers.controller('member-write-list', ['$scope', '$location', 'dialogs', 'ngTableParams', function ($scope, $location, dialogs, ngTableParams) {
        ...
        $scope.getBoardList = function () {
            $scope.tableParams = new ngTableParams({
                ...
                getData: function($defer, params) {
                    ...
                    $scope.getList('com/webboard', 'list', {NO: params.page() - 1, SIZE: $scope.PAGE_SIZE}, $scope._search, true)
                        .then(function(data){
