 ...
 * Date   : 2014-09-23
 * Description : webboard-edit.html 화면 콘트롤러
 */
...
define([
    ...
    // 사용할 서비스를 주입
    controllers.controller('webboard-edit', ['$scope', '$stateParams', '$location', 'dialogs', 'UPLOAD', function ($scope, $stateParams, $location, dialogs, UPLOAD) {
