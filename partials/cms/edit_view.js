...
define([
    ...
    // 사용할 서비스를 주입
    controllers.controller('edit_view', ['$scope', '$stateParams', 'contentService', '$sce', '$location', function ($scope, $stateParams, contentService, $sce, $location) {

        if ($scope.method == 'GET' && $stateParams.id != undefined){
            $scope.message = 'ANGE CMS';

            $scope.pageTitle = '기사 조회';
            $scope.pageDescription = '기사를 조회합니다.';
        }
