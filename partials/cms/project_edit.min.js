...
define([
    ...
    controllers.controller('project_edit', ['$scope', '$stateParams', '$location', 'dialogs', 'UPLOAD', function ($scope, $stateParams, $location, dialogs, UPLOAD) {
        ...
        $scope.setType = function(type) {
            $scope.file.type = type;
            $('#title').val(type);
//            alert($scope.file.type);
        };
        ...
        $scope.setFile = function(element) {
            ...
            $scope.$apply(function($scope) {
                ...
                $scope.item.FILE1 = JSON.stringify(element.files[0]);
        ...
        $scope.setFile2 = function(element) {
            $scope.$apply(function($scope) {
                $scope.item.FILE2 = JSON.stringify(element.files[0]);
                console.log(JSON.stringify($scope.item));
            });
        };
        ...
        $scope.$watch('file', function(data) {
            if (typeof data == 'object') {
                $scope.item.FILE = JSON.stringify(data);
