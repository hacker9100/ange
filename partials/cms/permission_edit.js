 ...
 * Date   : 2014-09-23
 * Description : permission_edit.html 화면 콘트롤러
 */
'use strict';
...
define([
    ...
    // 사용할 서비스를 주입
    controllers.controller('permission_edit', ['$scope', '$stateParams', 'permissionService', '$location', function ($scope, $stateParams, permissionService, $location) {
