...
define([
    ...
    // 사용할 서비스를 주입
    controllers.controller('article_confirm_view', ['$scope', '$stateParams', 'contentService', '$sce', '$location', function ($scope, $stateParams, contentService, $sce, $location) {
        ...
        $scope.editContent = function (no) {
            ...
            $location.path('/article_confirm/edit/'+no);
        };
