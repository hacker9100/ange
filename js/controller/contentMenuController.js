...
define([
    ...
    controllers.controller('ContentMenuCtrl', ['$rootScope', '$scope', '$state', '$location', function ($rootScope, $scope, $state, $location) {
        ...
        var menus = [{ 'state' : 'content', 'menu' : [{ 'name' : '업무정의', 'path' : '/content/task'}, { 'name' : '서브메뉴1-2', 'url' : 'partial/menu1-2.html'}]}, { 'state' : 'menagement', 'menu' : [{ 'name' : '서브메뉴2-1', 'url' : 'sub_menu2_1.html'}, { 'name' : '서브메뉴2-2', 'url' : 'sub_menu2_2.html'}]}];
