...
define(['./directives'], function (directives) {
    ...
    directives.directive('plUpload', ['$parse', 'plUploadProvider', function ($parse, plUploadProvider) {
        'use strict';
        ...
        return {
            ...
            link: function (scope, iElement, iAttrs) {
                ...
                if(!iAttrs.plUrl){
                    iAttrs.$set('plUrl', plUploadProvider.getConfig('uploadPath'));
                }
                if(!iAttrs.plFlashSwfUrl){
                    iAttrs.$set('plFlashSwfUrl', plUploadProvider.getConfig('flashPath'));
                }
                if(!iAttrs.plSilverlightXapUrl){
                    iAttrs.$set('plSilverlightXapUrl', plUploadProvider.getConfig('silverLightPath'));
                }
...
//                uploader.settings.headers = plUploadProvider.getConfig('headers');
