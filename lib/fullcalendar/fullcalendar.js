...
$.extend(DayGrid.prototype, {
	...
	// isRigid determins whether the individual rows should ignore the contents and be a config height.
...
$.extend(DayGrid.prototype, {
	...
	// Assumes the row is "rigid" (maintains a config height regardless of what is inside).
...
$.extend(BasicView.prototype, {
	...
	// Determines whether each row should have a config height
	...
	setHeight: function(totalHeight, isAuto) {
		...
		// is the event limit a config level number?
