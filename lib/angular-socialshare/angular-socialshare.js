    ...
    return {
      ...
      'link': function linkingFunction ($scope, element, attr) {
        ...
        $scope.facebookShare = function manageFacebookShare (data) {
          $window.open(
            '//www.facebook.com/sharer/sharer.php?u=' + encodeURI(data.url || $scope.share_url)
...
//            urlString += 'text=' + encodeURI(data.text);
            urlString += 'text=' + encodeURI(data.text || $scope.task.SUBJECT);
          }
...
//          urlString += '&url=' + encodeURI(data.url || $location.absUrl());
          urlString += '&url=' + encodeURI(data.url || $scope.share_url || $location.absUrl());
