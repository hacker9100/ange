...
class MtUtil extends Mt {
    ...
    function _c($msg,$line=true) {
        if (DEBUG) {
            $access = date("Y.m.d");
            $file_pointer = fopen("D:/xampp/htdocs/ange//migration/logs/debug".$access.".log", "a");
            $text = "";
            if ($line) {
    ...
    function _s($msg,$line=true) {
        if (DEBUG) {
            $access = date("Y.m.d");
            $file_pointer = fopen("D:/xampp/htdocs/ange//migration/logs/sql".$access.".log", "a");
            $text = "";
            if ($line) {
                $text = chr(10).date("Y/m/d H:i:s").":::::::::>"."\n";
                foreach (debug_backtrace() as $k => $v) {
    ...
    function _b($msg,$line=true) {
        if (DEBUG) {
            $access = date("Y.m.d");
            $file_pointer = fopen("D:/xampp/htdocs/ange//migration/logs/batch".$access.".log", "a");
            $text = "";
            if ($line) {
                $text = chr(10).date("Y/m/d H:i:s").":::::::::>"."\n";
                foreach (debug_backtrace() as $k => $v) {
    ...
    function _m($msg,$line=false) {
        $access = date("Y.m.d");
        $file_pointer = fopen("D:/xampp/htdocs/ange//logs/marking".$access.".log", "a");
    ...
    function _d($msg,$line=false) {
        $access = date("Y.m.d");
        $file_pointer = fopen("D:/xampp/htdocs/ange//logs/DATA.".$access.".log", "a");
    ...
    function _c2($msg) {
        $access = date("Y.m.d");
        $file_pointer = fopen("D:/xampp/htdocs/ange//logs/flash".$access.".log", "a");
        $text = chr(10).date("Y/m/d H:i:s").":::::::::>"."\n";
